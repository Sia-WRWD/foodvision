...
export class AllergyInformationComponent {
  ...
  symptoms: any =
    [
      ...
      { name: "Swelling Face ⚠️", img: "../../../../assets/symptom-img/swollen-face.jpg", description: "Swelling or puffiness of the face.", threatLevel: "Moderate" },
  ...
  ngOnInit() {
    this.selectedSymptom = "Eczema ✅";
    this.selectedTreatment = "Adrenaline Injection"
  }

  displaySymptom(symptomName: string) {
    this.selectedSymptom = symptomName;
  }

  displayTreatment(treatmentName: string) {
